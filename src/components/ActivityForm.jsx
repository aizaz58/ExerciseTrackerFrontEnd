    ...
    <div className='container'>
      ...
      <form className="row g-3 needs-validation" onSubmit={handleSubmit} novalidate>
        <div className="col-md-6">
          ...
          <input ref={nameRef} type="text" className="form-control" name='name' id="validationCustom01" onChange={handleChange} value={formData.name} required />
        ...
        <div className="col-md-6">
          ...
          <select ref={typeRef} className="form-select" id="validationCustom04" name="type" onChange={handleChange} value={formData.type} required>
        ...
        <div className="col-md-6">
          ...
          <input ref={durationRef} type="text" className="form-control" id="validationCustom02" onChange={handleChange} value={formData.duration} name="duration" placeholder="Add duration in minutes like, 08" required />
          <div className="invalid-feedback">
            Looks good!
          </div>
        </div>
        <div className="col-md-6">
          ...
          <input ref={dateRef} type="date" className="form-control" onChange={handleChange} value={formData.date} id="validationCustom03" name='date' placeholder="DD/MM/YYYY" required />
          <div className="invalid-feedback">
        ...
        <div className="col-md-12">
          ...
          <textarea ref={descriptionRef} type="text" className="form-control" onChange={handleChange} value={formData.description} id="validationCustom05" name='description' placeholder="You can add description here.. " required></textarea>
          <div className="invalid-feedback">
